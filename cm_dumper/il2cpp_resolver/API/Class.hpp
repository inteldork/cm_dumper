//this has been heavily modified from original source, but is still mostly il2cppresolver's code.
//most of this is not written by me originally, the repo for the main source is in the README, go check out the original! :)
...
namespace IL2CPP
{
    namespace Class
    {
        ...
        static void FetchProperties(Unity::il2cppClass* klass, std::vector<Unity::il2cppPropertyInfo*>* properties) {
            if (!klass || !properties || !IL2CPP::Functions.m_ClassGetProperties)
                return;
            void* iter = nullptr;
            Unity::il2cppPropertyInfo* prop = nullptr;

            while ((prop = ((Unity::il2cppPropertyInfo * (*)(Unity::il2cppClass*, void**))
                IL2CPP::Functions.m_ClassGetProperties)(klass, &iter)) != nullptr)
            {
                if (prop)
